...
**The price elasticity of demand for sardines is -1.545. We can say with 95% confidence that the the range of -1.699 to -1.392 contains to true price elasticity value.** 
...
**The F-statistic is 144.65, which means the instruments are relevant and non-weak.** 
...
# TSLS - JUST-IDENTIFIED MODEL
# Lecture 8, slide 13
tsls2 <- ivreg(log(volume_sold_kg) ~ log(price_euro_kg) | wind_m_s + as.factor(country) + as.factor(year) + as.factor(month), 
